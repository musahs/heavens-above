...
/**
 * Function to get the table data from the IridiumFlares page.
 * @param {Object} config - The configuration object.
 * @param {Array} config.database - The database array to store the scraped data.
 * @param {number} config.counter - The counter to keep track of the number of pages scraped.
